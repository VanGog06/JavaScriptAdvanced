function createComputerHierarchy() {
    ...
    class Keyboard extends AbstractComponent {
    ...
    class Monitor extends AbstractComponent {
    ...
    class Battery extends AbstractComponent {
    ...
    class Computer extends AbstractComponent{
        constructor(manufacturer, processorSpeed, ram, hardDiskSpace) {
            if (new.target == Computer) {
                throw new Error('Cannot create objects from Abstract class');
            }
